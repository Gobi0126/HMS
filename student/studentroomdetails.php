...
<div class="room">
  <br><br>
  <h2 style="font-family: CASTELLER; margin-bottom:5%;">Room Details</h2>
  <br>
</div>
<div class="card" style="margin-bottom: 10%;">

  <img class="avatar" style="border-radius: 100px; height:10%; width:50% ;margin-left: 25%"  src= "../user.png"  >
  <br>
  <br>
